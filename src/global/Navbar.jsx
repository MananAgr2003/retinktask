...
export const Navbar = () => {
  return (
    <header class="bg-[#ffffff] w-[94vw] absolute left-[80px] top-0 hidden lg:block">
      <div class="container mx-auto px-4 py-[15px] flex items-center">
        <div class="w-full bg-transparent rounded-md hidden xl:flex items-center">
          <img src={searchIcon} alt="" class="relative h-5 w-5 left-8" />

          <input
            class="border-l border-gray-300 bg-white text-sm w-[480px] font-light px-12 py-4 rounded-md shadow-md"
            type="text"
            placeholder="Search for templates, projects, etc."
          />
          <button
            href="#"
            class="block bg-white border-2 text-[#7d58e9] border-[#7d58e9] hover:bg-[#7d58e9] hover:text-white relative left-[280px] py-2 px-8 rounded-[50px]"
          >
            Create Content
          </button>
          <button
            href="#"
            class="block bg-white border-2 text-[#7d58e9] border-[#7d58e9] hover:bg-[#7d58e9] hover:text-white left-[310px] relative py-2 px-4 rounded-[50px]"
          >
            20
          </button>
        </div>
        <div class="absolute hidden flex-row bg-[#f1edfd] top-[-30px] right-0 h-[80px] w-[350px] items-center justify-between p-14 lg:flex">
          <svg
